...
#Import external repository rules.
            load("@bazel_tools//tools/build_defs/repo:java.bzl",
...
#Import third party repository rules.See go / tfbr - thirdparty.
                        load("//third_party/absl:workspace.bzl", absl = "repo")
                            load("//third_party/benchmark:workspace.bzl",
                                 benchmark = "repo")
                                load(
                                    "//third_party/"
                                    "clang_toolchain:cc_configure_clang.bzl",
                                    "cc_download_clang_toolchain")
                                    load("//third_party/ducc:workspace.bzl",
                                         ducc = "repo")
                                        load(
                                            "//third_party/"
                                            ...
                                            load(
                                                "//third_party/"
                                                "farmhash:workspace.bzl",
                                                farmhash = "repo")
                                                load(
                                                    "//third_party/"
                                                    "gemmlowp:workspace.bzl",
                                                    gemmlowp = "repo")
                                                    load(
                                                        "//third_party/"
                                                        "git:git_configure.bzl",
                                                        "git_configure")
                                                        load(
                                                            "//third_party/"
                                                            "gpus:rocm_"
                                                                                                        ...
                                                                                                        load(
                                                                                                            ...
                                                                                                            load(
                                                                                                                ...
                                                                                                                load(
                                                                                                                    ...
                                                                                                                    load(
                                                                                                                        "//tools/toolchains:cpus/aarch64/aarch64_compiler_configure.bzl",
                                                                                                                        "aarch64_compiler_configure")
                                                                                                                        load(
                                                                                                                            "//tools/toolchains:cpus/arm/arm_compiler_configure.bzl",
                                                                                                                            "arm_compiler_configure")
                                                                                                                            load(
                                                                                                                                "//tools/toolchains/clang6:repo.bzl",
                                                                                                                                "clang6_configure")
                                                                                                                                load(
                                                                                                                                    "//tools/toolchains/embedded/arm-linux:arm_linux_toolchain_configure.bzl",
                                                                                                                                    "arm_linux_toolchain_configure")
                                                                                                                                    load(
                                                                                                                                        "//tools/toolchains/remote:configure.bzl",
    ...
    : ""
      ...
      "" absl() benchmark() ducc() eigen3() farmhash() gemmlowp() hwloc()
          implib_so() ml_dtypes() nasm() nvshmem() pybind11_abseil()
              pybind11_bazel() tensorrt()
...
#Toolchains& platforms required by Tensorflow to build.
    ...
    : native
          .register_execution_platforms(
              "@local_execution_config_platform//:platform") native
...
#Note that we check the minimum bazel version in WORKSPACE.
                  clang6_configure(name = "local_config_clang6") cc_download_clang_toolchain(
                      name = "local_config_download_clang")
                      tensorrt_configure(name = "local_config_tensorrt") git_configure(
                          name =
                              "local_config_git") syslibs_configure(name =
                                                                        "local_"
                                                                        "config"
                                                                        "_sysli"
                                                                        "bs")
                          python_configure(
                              name =
                                  "local_config_python") rocm_configure(name =
                                                                            "lo"
                                                                            "ca"
                                                                            "l_"
                                                                            "co"
...
#TODO : Remove def file filter when TensorFlow can export symbols properly on \
    Windows.
                                      def_file_filter_configure(
                                          name = "local_config_def_file_filter")

#Point  // external/local_config_arm_compiler to //external/arm_compiler
                                          arm_compiler_configure(
                                              name =
                                                  "local_config_arm_compiler",
                                              build_file =
                                                  "//tools/toolchains/cpus/"
                                                  "arm:template.BUILD",
                                              remote_config_repo_arm =
                                                  "../arm_compiler",
                                              remote_config_repo_aarch64 =
                                                  "../aarch64_compiler", )
...
#LINT.IfChange
      tf_http_archive(
              name = "XNNPACK",
              sha256 =
                  "9e290e7b094134bdda0cad4ef4b89625fbde3c4b8e8f5dc84044c0f2e55b"
                  "875a",
              strip_prefix = "XNNPACK-5b4978cae19292232a27bdf0f495819bf5297167",
              urls = tf_mirror_urls(
                  "https://github.com/google/XNNPACK/archive/"
                  "5b4978cae19292232a27bdf0f495819bf5297167.zip"), )
#LINT.ThenChange(  // tensorflow/lite/tools/cmake/modules/xnnpack.cmake)

          tf_http_archive(
              name = "FXdiv",
              sha256 =
                  "3d7b0e9c4c658a84376a1086126be02f9b7f753caa95e009d9ac38d11da4"
                  "44db",
              strip_prefix = "FXdiv-63058eff77e11aa15bf531df5dd34395ec3017c8",
              urls = tf_mirror_urls(
                  "https://github.com/Maratyszcza/FXdiv/archive/"
                  "63058eff77e11aa15bf531df5dd34395ec3017c8.zip"), )

              tf_http_archive(
                  name = "pthreadpool",
                  sha256 =
                      "215724985c4845cdcadcb5f26a2a8777943927bb5a172a00e7716fe1"
                      "6a6f3c1b",
                  strip_prefix =
                      "pthreadpool-b1aee199d54003fb557076a201bcac3398af580b",
                  urls = tf_mirror_urls(
                      "https://github.com/google/pthreadpool/archive/"
                      "b1aee199d54003fb557076a201bcac3398af580b.zip"), )

                  tf_http_archive(
                      name = "cpuinfo",
                      sha256 =
                          "52e0ffd7998d8cb3a927d8a6e1145763744d866d2be09c4eccea"
                          "27fc157b6bb0",
                      strip_prefix =
                          "cpuinfo-cebb0933058d7f181c979afd50601dc311e1bf8c",
                      urls = tf_mirror_urls(
                          "https://github.com/pytorch/cpuinfo/archive/"
                          "cebb0933058d7f181c979afd50601dc311e1bf8c.zip"), )

                      tf_http_archive(
                          name = "mkl_dnn_v1",
                          build_file = "//third_party/mkl_dnn:mkldnn_v1.BUILD",
                          sha256 =
                              "dc2b9bc851cd8d5a6c4622f7dc215bdb6b32349962875f8b"
                              "f55cceed45a4c449",
                          strip_prefix = "oneDNN-2.7.1",
                          urls = tf_mirror_urls(
                              "https://github.com/oneapi-src/oneDNN/archive/"
                              "refs/tags/v2.7.1.tar.gz"), )
                          ...
                          tf_http_archive(
                              ...
                              sha256 =
                                  "8356aa9befde4d4ff93f1b016ac4310730b2de0cc0b8"
                                  "c6c7ce306690bc0d7b43",
                              strip_prefix = "oneDNN-3.5",
                              urls = tf_mirror_urls(
                                  "https://github.com/oneapi-src/oneDNN/"
                                  "archive/refs/tags/v3.5.tar.gz"), )
                              ...
                              tf_http_archive(
                                  ...
                                  patch_file =
                                      [
                                        "//third_party/"
                                        "mkl_dnn:onednn_acl_threadcap.patch",
                                        "//third_party/"
                                        "mkl_dnn:onednn_acl_reorder.patch",
                                        "//third_party/"
                                        "mkl_dnn:onednn_acl_thread_local_"
                                        "scheduler.patch",
                                        "//third_party/"
                                        "mkl_dnn:onednn_acl_fp32_bf16_reorder."
                                        "patch",
                                        "//third_party/"
                                        "mkl_dnn:onednn_acl_bf16_capability_"
                                        "detection_for_ubuntu20.04.patch",
                                        "//third_party/"
                                        "mkl_dnn:onednn_acl_indirect_conv."
                                        "patch",
                                        "//third_party/"
                                        "mkl_dnn:onednn_acl_allow_blocked_"
                                        "weight_format_for_matmul_primitive."
                                        "patch",
                                        "//third_party/"
                                        "mkl_dnn:onednn_acl_fix_segfault_"
                                        "during_postop_execute.patch",
                                        "//third_party/"
                                        "mkl_dnn:onednn_acl_add_bf16_platform_"
                                        "support_check.patch",
                                        "//third_party/"
                                        "mkl_dnn:onednn_acl_add_sbgemm_matmul_"
                                        "primitive_definition.patch",
                                      ],
                                  sha256 =
                                      "2f76b407ef8893cca71340f88cd800019a1f14f8"
                                      "ac1bbdbb89a84be1370b52e3",
                                  strip_prefix = "oneDNN-3.2.1",
                                  urls = tf_mirror_urls(
                                      "https://github.com/oneapi-src/oneDNN/"
                                      "archive/refs/tags/v3.2.1.tar.gz"), )
                                  ...
                                  tf_http_archive(
                                      ...
                                      patch_file =
                                          [
                                            "//third_party/"
                                            "compute_library:compute_library."
                                            "patch",
                                            "//third_party/"
                                            "compute_library:acl_thread_local_"
                                            "scheduler.patch",
                                            "//third_party/"
                                            "compute_library:exclude_omp_"
                                            "scheduler.patch",
                                            "//third_party/"
                                            "compute_library:include_string."
                                            "patch",
                                          ],
                                      sha256 =
                                          "c4ca329a78da380163b2d86e91ba728349b6"
                                          "f0ee97d66e260a694ef37f0b0d93",
                                      strip_prefix = "ComputeLibrary-23.05.1",
                                      urls = tf_mirror_urls(
                                          "https://github.com/ARM-software/"
                                          "ComputeLibrary/archive/"
                                          "v23.05.1.tar.gz"), )
                                      ...
                                      tf_http_archive(
                                          ...
                                          sha256 =
                                              "b9e7d50ffd9996ed18900d041d362c99"
                                              "473b382c0ae049b2fce3290632d2656"
                                              "f",
                                          strip_prefix =
                                              "rpi-newer-crosstools-"
                                              "eb68350c5c8ec1663b7fe52c742ac427"
                                              "1e3217c5/x64-gcc-6.5.0/"
                                              "arm-rpi-linux-gnueabihf/",
                                          urls = tf_mirror_urls(
                                              "https://github.com/rvagg/"
                                              "rpi-newer-crosstools/archive/"
                                              "eb68350c5c8ec1663b7fe52c742ac427"
                                              "1e3217c5.tar.gz"), )
...
#The archive contains GCC version 9.2.1
                                              ...
                                              build_file =
                                                  "//:arm_compiler.BUILD",
                                              sha256 =
                                                  "8dfe681531f0bd04fb9c53cf3c0a"
                                                  "3368c616aa85d48938eebe2b5163"
                                                  "76e06a66",
                                              strip_prefix =
                                                  "gcc-arm-9.2-2019.12-x86_64-"
                                                  "aarch64-none-linux-gnu",
                                              urls = tf_mirror_urls(
                                                  "https://developer.arm.com/-/"
                                                  "media/Files/downloads/gnu-a/"
                                                  "9.2-2019.12/binrel/"
                                                  "gcc-arm-9.2-2019.12-x86_64-"
                                                  "aarch64-none-linux-gnu.tar."
                                                  "xz"), )
                                              ...
                                              tf_http_archive(
                                                  ...
                                                  build_file =
                                                      ...
                                                      "toolchain.BUILD",
                                                  sha256 =
                                                      "50cdef6c5baddaa00f60502c"
                                                      "c8b59cc11065306ae575ad2f"
                                                      "51e412a9b2a90364",
                                                  strip_prefix =
                                                  ...
                                                  tf_http_archive(
                                                      ...
                                                      build_file =
                                                          ...
                                                          "BUILD",
                                                      sha256 =
                                                          "3f76650b1d048036473b"
                                                          "16b647b8fd005ffccd1a"
                                                          "2869c10994967e0e49f2"
                                                          "6ac2",
                                                      strip_prefix =
                                                          "arm-gnu-toolchain-"
                                                          "11.3.rel1-x86_64-"
                                                                      ...
                                                                      filegroup_external(
                                                                          ...
                                                                          tf_http_archive(
                                                                              name =
                                                                                  "absl_py",
                                                                              sha256 =
                                                                                  "a7c51b2a0aa6357a9cbb2d9437e8cd787200531867dc02565218930b6a32166e",
                                                                              strip_prefix =
                                                                                  "abseil-py-1.0.0",
                                                                              system_build_file =
                                                                                  ...
                                                                                  tf_http_archive(
                                                                                      ...
                                                                                      system_link_files = {
                                                                                        "//third_party/systemlibs:protobuf.bzl" :
                                                                                            "protobuf.bzl",
                                                                                        "//third_party/systemlibs:protobuf_deps.bzl" :
                                                                                            "protobuf_deps.bzl",
                                                                                      },
                                                                                      urls = tf_mirror_urls(
                                                                                      ...
                                                                                      tf_http_archive(
                                                                                          ...
                                                                                          tf_http_archive(
                                                                                              name =
                                                                                                  "com_google_fuzztest",
                                                                                              sha256 =
                                                                                                  "d922940bde8904937b9e13298f06b1d59388ab4a965122860358b00535438f63",
                                                                                              strip_prefix =
                                                                                                  "fuzztest-e576caaece16bd1f8dcd196736743c36474f3c16",
                                                                                              urls = tf_mirror_urls(
                                                                                                  "https://github.com/google/fuzztest/archive/e576caaece16bd1f8dcd196736743c36474f3c16.zip"), )
...
#WARNING : make sure ncteisen @and vpai @are cc - \
    ed on any CL to change the below rule
                                                                                                      tf_http_archive(
                                                                                                          name =
                                                                                                              "com_github_grpc_grpc",
                                                                                                          sha256 =
                                                                                                              "b956598d8cbe168b5ee717b5dafa56563eb5201a947856a6688bbeac9cac4e1f",
                                                                                                          strip_prefix =
                                                                                                              "grpc-b54a5b338637f92bfcf4b0bc05e0f57a5fd8fadd",
                                                                                                          system_build_file =
                                                                                                          ...
                                                                                                          system_link_files =
                                                                                                              {
                                                                                                                ...
                                                                                                                "//third_party/systemlibs:grpc.bazel.generate_cc.bzl" :
...
#Intel openMP that is part of LLVM sources.
                                                                                                              tf_http_archive(
                                                                                                                  name =
                                                                                                                      "llvm_openmp",
                                                                                                                  build_file =
                                                                                                                      "//third_party/llvm_openmp:BUILD.bazel",
                                                                                                                  patch_file =
                                                                                                                  ...
                                                                                                                  tf_http_archive(
                                                                                                                      ...
                                                                                                                      tf_http_archive(
                                                                                                                          ...
                                                                                                                          tf_http_archive(name =
                                                                                                                                              "snappy",
                                                                                                                                          build_file =
                                                                                                                                              "//third_party:snappy.BUILD",
                                                                                                                                          sha256 =
                                                                                                                                              "2e458b7017cd58dcf1469ab315389e85e7f445bd035188f2983f81fb19ecfb29",
                                                                                                                                          strip_prefix =
                                                                                                                                              "snappy-984b191f0fefdeb17050b42a90b7625999c13b8d",
                                                                                                                                          system_build_file =
                                                                                                                              ...
                                                                                                                              tf_http_archive(
                                                                                                                                  ...
                                                                                                                                  sha256 =
                                                                                                                                      "7b154ad1f8ccafa795ed6696507d402b1b4ccac944c5fceb7f4e29b19a39cc47",
                                                                                                                                  strip_prefix =
                                                                                                                                      "nccl-2.25.1-1",
                                                                                                                                  urls = tf_mirror_urls(
                                                                                                                                      "https://github.com/nvidia/nccl/archive/v2.25.1-1.tar.gz"), )

                                                                                                                                  tf_http_archive(
                                                                                                                                      name =
                                                                                                                                          "nvtx_archive",
                                                                                                                                      build_file =
                                                                                                                                          "//third_party:nvtx/BUILD.bazel",
                                                                                                                                      sha256 =
                                                                                                                                          "e4438f921fb88a564b0b92791c1c1fdd0f388901213e6a31fdd0dc3803fb9764",
                                                                                                                                      strip_prefix =
                                                                                                                                          "NVTX-bf31d7859ab3130cbf1ef77c33d18d0ebb8c8d08/c/include",
                                                                                                                                      urls = tf_mirror_urls(
                                                                                                                                          "https://github.com/NVIDIA/NVTX/archive/bf31d7859ab3130cbf1ef77c33d18d0ebb8c8d08.tar.gz"), )

                                                                                                                                      java_import_external(name =
                                                                                                                                                               "junit",
                                                                                                                                                           jar_sha256 =
                                                                                                                                              ...
                                                                                                                                              java_import_external(name =
                                                                                                                                                  ...
                                                                                                                                                  java_import_external(
                                                                                                                                                      ...
                                                                                                                                                      java_import_external(
                                                                                                                                                          ...
                                                                                                                                                          jar_sha256 =
                                                                                                                                                              "d261fde25d590f6b69db7721d469ac1b0a19a17ccaaaa751c31f0d8b8260b894",
                                                                                                                                                          jar_urls =
                                                                                                                                                              [
                                                                                                                                                          ...
                                                                                                                                                          java_import_external(
                                                                                                                                                              ...
                                                                                                                                                              tf_http_archive(name =
                                                                                                                                                                              ...
                                                                                                                                                                              sha256 =
                                                                                                                                                                                  "0c2eae8a4ceab7955be1e11a4ddc5dcc3aa06ce22ad594262f1555b9d10667f0",
                                                                                                                                                                              strip_prefix =
                                                                                                                                                                                  "cython-3.0.3",
                                                                                                                                                                              system_build_file =
                                                                                                                                                                                  "//third_party/systemlibs:cython.BUILD",
                                                                                                                                                                              urls = tf_mirror_urls(
                                                                                                                                                                                  "https://github.com/cython/cython/archive/3.0.3.tar.gz"), )
...
#https:  // github.com/bazelbuild/rules_apple/releases
                                                                                                                                                                      tf_http_archive(
                                                                                                                                                                          ...
                                                                                                                                                                          sha256 =
                                                                                                                                                                              "b4df908ec14868369021182ab191dbd1f40830c9b300650d5dc389e0b9266c8d",
                                                                                                                                                                          urls = tf_mirror_urls(
...
#https:  // github.com/bazelbuild/rules_swift/releases
                                                                                                                                                                          tf_http_archive(name =
                                                                                                                                                                                          ...
                                                                                                                                                                                          sha256 =
                                                                                                                                                                                              "bb01097c7c7a1407f8ad49a1a0b1960655cf823c26ad2782d0b7d15b323838e2",
                                                                                                                                                                                          urls = tf_mirror_urls(
...
#https:  // github.com/bazelbuild/apple_support/releases
                                                                                                                                                                              tf_http_archive(name =
                                                                                                                                                                                              ...
                                                                                                                                                                                              sha256 =
                                                                                                                                                                                                  "d71b02d6df0500f43279e22400db6680024c1c439115c57a9a82e9effe199d7b",
                                                                                                                                                                                              urls = tf_mirror_urls(
                                                                                                                                                                                                  "https://github.com/bazelbuild/apple_support/releases/download/1.18.1/apple_support.1.18.1.tar.gz"), )
...
#https:  // github.com/apple/swift-protobuf/releases
                                                                                                                                                                                  tf_http_archive(
                                                                                                                                                                                      ...
                                                                                                                                                                                      strip_prefix =
                                                                                                                                                                                          "swift-protobuf-1.19.0/",
                                                                                                                                                                                      sha256 =
                                                                                                                                                                                          "f057930b9dbd17abeaaceaa45e9f8b3e87188c05211710563d2311b9edf490aa",
                                                                                                                                                                                      urls = tf_mirror_urls(
                                                                                                                                                                                          "https://github.com/apple/swift-protobuf/archive/1.19.0.tar.gz"), )
...
#https:  // github.com/google/xctestrunner/releases
                                                                                                                                                                                      tf_http_archive(name =
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      strip_prefix =
                                                                                                                                                                                                          "xctestrunner-0.2.15",
                                                                                                                                                                                                      sha256 =
                                                                                                                                                                                                          "b789cf18037c8c28d17365f14925f83b93b1f7dabcabb80333ae4331cf0bcb2f",
                                                                                                                                                                                                      urls = tf_mirror_urls(
                                                                                                                                                                                                          "https://github.com/google/xctestrunner/archive/refs/tags/0.2.15.tar.gz"), )
    ...
    .
                                                                                                                                                                                                  tf_http_archive(
                                                                                                                                                                                                      name =
                                                                                                                                                                                                          "io_bazel_rules_go",
                                                                                                                                                                                                      sha256 =
                                                                                                                                                                                                          "16e9fca53ed6bd4ff4ad76facc9b7b651a89db1689a2877d6fd7b82aa824e366",
                                                                                                                                                                                                      urls =
                                                                                                                                                                                                          tf_mirror_urls(
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      tf_http_archive(
                                                                                                                                                                                                          name =
                                                                                                                                                                                                              "upb",
                                                                                                                                                                                                          sha256 =
                                                                                                                                                                                                              "61d0417abd60e65ed589c9deee7c124fe76a4106831f6ad39464e1525cef1454",
                                                                                                                                                                                                          strip_prefix =
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          tf_http_archive(
                                                                                                                                                                                                              ...
                                                                                                                                                                                                              tf_http_archive(
                                                                                                                                                                                                                  name =
                                                                                                                                                                                                                      "spirv_headers",
                                                                                                                                                                                                                  sha256 =
                                                                                                                                                                                                                      "11d835c60297b26532c05c3f3b581ba7a2787b5ae7399e94f72c392169216f11",
                                                                                                                                                                                                                  strip_prefix =
                                                                                                                                                                                                                      "SPIRV-Headers-b73e168ca5e123dcf3dea8a34b19a5130f421ae1",
                                                                                                                                                                                                                  urls = tf_mirror_urls(
                                                                                                                                                                                                                      "https://github.com/KhronosGroup/SPIRV-Headers/archive/b73e168ca5e123dcf3dea8a34b19a5130f421ae1.tar.gz"), )

                                                                                                                                                                                                                  tf_http_archive(
                                                                                                                                                                                                                      name =
                                                                                                                                                                                                                          "spirv_llvm_translator",
                                                                                                                                                                                                                      sha256 =
                                                                                                                                                                                                                          "d499769f4fd1e0ce9d4dbd3622ee7e3e641b5623dcdf811521e3e7c0bdb1e6c2",
                                                                                                                                                                                                                      strip_prefix =
                                                                                                                                                                                                                          "SPIRV-LLVM-Translator-dad1f0eaab8047a4f73c50ed5f3d1694b78aae97",
                                                                                                                                                                                                                      build_file =
                                                                                                                                                                                                                          "//third_party/spirv_llvm_translator:spirv_llvm_translator.BUILD",
                                                                                                                                                                                                                      patch_file = ["//third_party/spirv_llvm_translator:spirv_llvm_translator.patch"], urls = tf_mirror_urls("https://github.com/KhronosGroup/SPIRV-LLVM-Translator/archive/dad1f0eaab8047a4f73c50ed5f3d1694b78aae97.tar.gz"), )
