...
TEST(BlockLevelParametersTest,
  ...
  *block_level_fusion_config.add_output_tiles() = tile;
  ...
  block_level_fusion_config.set_matrix_instr_nonkdim(16);
  ...
  EXPECT_THAT(block_level_parameters.matrix_instr_nonkdim, 16);
}
...
TEST(BlockLevelParametersTest,
  ...
  block_level_parameters.matrix_instr_nonkdim = 16;
  ...
  EXPECT_THAT(block_level_fusion_config.matrix_instr_nonkdim(), 16);
}
