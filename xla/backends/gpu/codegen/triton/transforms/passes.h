...
std::unique_ptr<mlir::Pass> CreateTritonXLALowerAtomicsROCmPass();
std::unique_ptr<mlir::Pass> CreateTritonXLALowerAtomicsROCmAsmPass();
std::unique_ptr<mlir::Pass> CreateTritonXLALowerBlockBarrierPass();
std::unique_ptr<mlir::Pass> CreateTritonXLALowerBlockBarrierROCmPass();
std::unique_ptr<mlir::Pass> CreateTritonXLALowerBlockBarrierROCmAsmPass();
std::unique_ptr<mlir::Pass> CreateTritonXLALowerGetTidROCmAsmPass();
