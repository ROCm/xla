...
module attributes {llvm.target_triple = "amdgcn-amd-amdhsa"} {
  ...
  // CHECK-NOT: llvm.func @xla_get_thread_id
  // CHECK-NOT: llvm.func @xla_atomic_write_release_system
  // CHECK-NOT: llvm.func @xla_atomic_write_relaxed_system
  // CHECK-NOT: llvm.func @xla_atomic_write_release_gpu
  // CHECK-NOT: llvm.func @xla_atomic_write_release_cta
  // CHECK-NOT: llvm.func @xla_atomic_spin_wait_acquire_system_lt
  // CHECK-NOT: llvm.func @xla_atomic_spin_wait_acquire_system_eq
