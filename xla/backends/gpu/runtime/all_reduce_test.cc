...
INSTANTIATE_TEST_SUITE_P(AllReduceKernelTest, AllReduceKernelTest,
                         ::testing::ValuesIn(std::vector<TestParams>{
                             {AllReduceStrategy::kOneShot, 128000},
                             {AllReduceStrategy::kOneShot, 124000},
                             {AllReduceStrategy::kTwoShot, 128000},
                             {AllReduceStrategy::kTwoShot, 124000},
                         }),
                         [](const ::testing::TestParamInfo<TestParams>& info) {
                           return absl::StrFormat(
                               "%v_%d", info.param.all_reduce_strategy,
