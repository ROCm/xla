...
class CollectiveKernelThunk : public Thunk {
 public:
  ...
  CollectiveKernelThunk(ThunkInfo info, NcclCollectiveConfig collective_config,
      ...
      : Thunk{Thunk::kCustomCollectiveKernel, info},
 ...
 private:
  ...
  const NcclCollectiveConfig collective_config_;
  ...
  absl::Span<const NcclCollectiveThunk::Buffer> buffers_;
