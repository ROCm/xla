...
TritonBackend::GetSupportedConfigs(const HloInstruction& instr) const {
...
absl::StatusOr<std::vector<std::unique_ptr<BackendConfig>>>
TritonBackend::GetSupportedConfigsForDot(const HloInstruction* instr) const {
...
absl::StatusOr<std::vector<std::unique_ptr<BackendConfig>>>
TritonBackend::GetOverriddenConfigs(const HloInstruction* instr) const {
  std::vector<std::unique_ptr<BackendConfig>> configs;
