...
# --- AITER gfx950 winners (confirmed useful on Gemma3 1B + Gemma2 2B; 284 unused dropped) ---
config { block_m: 16 block_n: 8 block_k: 256 split_k: 1 num_stages: 1 num_warps: 2 num_ctas: 1 }  # gemma2-2b
config { block_m: 16 block_n: 16 block_k: 128 split_k: 4 num_stages: 2 num_warps: 2 num_ctas: 1 }  # gemma3-1b
config { block_m: 16 block_n: 16 block_k: 128 split_k: 8 num_stages: 1 num_warps: 2 num_ctas: 1 }  # gemma3-1b
config { block_m: 16 block_n: 16 block_k: 128 split_k: 8 num_stages: 2 num_warps: 2 num_ctas: 1 }  # gemma3-1b
config { block_m: 16 block_n: 64 block_k: 128 split_k: 1 num_stages: 2 num_warps: 2 num_ctas: 1 }  # gemma2-2b
config { block_m: 32 block_n: 16 block_k: 64 split_k: 8 num_stages: 1 num_warps: 4 num_ctas: 1 }   # gemma3-1b
config { block_m: 64 block_n: 8 block_k: 16 split_k: 4 num_stages: 3 num_warps: 2 num_ctas: 1 }    # gemma3-1b
config { block_m: 64 block_n: 8 block_k: 64 split_k: 16 num_stages: 2 num_warps: 2 num_ctas: 1 }   # gemma2-2b
config { block_m: 64 block_n: 8 block_k: 128 split_k: 1 num_stages: 3 num_warps: 2 num_ctas: 1 }   # gemma3-1b (s=3 vs original s=4)
config { block_m: 64 block_n: 8 block_k: 256 split_k: 1 num_stages: 2 num_warps: 2 num_ctas: 1 }   # gemma2-2b
config { block_m: 64 block_n: 16 block_k: 256 split_k: 16 num_stages: 1 num_warps: 4 num_ctas: 1 } # gemma3-1b
config { block_m: 128 block_n: 8 block_k: 32 split_k: 1 num_stages: 1 num_warps: 4 num_ctas: 1 }   # gemma2-2b
config { block_m: 128 block_n: 32 block_k: 64 split_k: 16 num_stages: 1 num_warps: 4 num_ctas: 1 } # gemma2-2b
config { block_m: 128 block_n: 64 block_k: 16 split_k: 1 num_stages: 1 num_warps: 4 num_ctas: 1 }  # gemma3-1b
)";
