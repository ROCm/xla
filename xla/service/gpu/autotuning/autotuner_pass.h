...
class AutotunerPass : public HloModulePass {
 public:
  explicit AutotunerPass(stream_executor::StreamExecutor* stream_executer,
                         tsl::thread::ThreadPool* thread_pool)
      : stream_executer_(stream_executer), thread_pool_(thread_pool) {}
 ...
 private:
  stream_executor::StreamExecutor* stream_executer_;
