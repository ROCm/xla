...
// out after approximately 100ms if that value is not reached. This can happen
// if, for example, blocking launches are enabled via HIP_LAUNCH_BLOCKING=1. It
// can also happen if launching a kernel after this delay kernel causes
// synchronisation, e.g. because of lazy loading.
