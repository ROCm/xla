...
// Tuning parameters from rocPRIM's default_scan_config_base (device-level
// header).
template <typename T>
struct ScanConfig {
  using RocprimConfig =
...
__launch_bounds__(ScanConfig<T>::kBlockSize) __global__
  ...
  using BlockLoadT =
      rocprim::block_load<T, kBlockSize, kItemsPerThread,
                          rocprim::block_load_method::block_load_transpose>;
  using BlockStoreT =
      rocprim::block_store<T, kBlockSize, kItemsPerThread,
                           rocprim::block_store_method::block_store_transpose>;
  using BlockScanT =
      rocprim::block_scan<T, kBlockSize,
